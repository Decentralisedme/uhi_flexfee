...
var _ReceiptData = class _ReceiptData extends pb_12.Message {
  constructor(data) {
    ...
    pb_12.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __privateGet(this, _one_of_decls2));
    if (!Array.isArray(data) && typeof data == "object") {
...
var _Field = class _Field extends pb_12.Message {
  constructor(data) {
    ...
    pb_12.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __privateGet(this, _one_of_decls3));
    if (!Array.isArray(data) && typeof data == "object") {
      if ("contract" in data && data.contract != void 0) {
        this.contract = data.contract;
      }
      if ("log_index" in data && data.log_index != void 0) {
...
var _ProveRequest = class _ProveRequest extends pb_13.Message {
  constructor(data) {
    ...
    pb_13.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1, 2, 3], __privateGet(this, _one_of_decls10));
    if (!Array.isArray(data) && typeof data == "object") {
...
var _ProveResponse = class _ProveResponse extends pb_13.Message {
  constructor(data) {
    ...
    pb_13.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __privateGet(this, _one_of_decls11));
    if (!Array.isArray(data) && typeof data == "object") {
...
var _ReceiptInfo = class _ReceiptInfo extends pb_14.Message {
  constructor(data) {
    ...
    pb_14.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __privateGet(this, _one_of_decls16));
    if (!Array.isArray(data) && typeof data == "object") {
...
var _LogExtractInfo = class _LogExtractInfo extends pb_14.Message {
  constructor(data) {
    ...
    pb_14.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __privateGet(this, _one_of_decls17));
    if (!Array.isArray(data) && typeof data == "object") {
...
var _StorageQueryInfo = class _StorageQueryInfo extends pb_14.Message {
  constructor(data) {
    ...
    pb_14.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __privateGet(this, _one_of_decls18));
    if (!Array.isArray(data) && typeof data == "object") {
...
var _TransactionInfo = class _TransactionInfo extends pb_14.Message {
  constructor(data) {
    ...
    pb_14.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __privateGet(this, _one_of_decls19));
    if (!Array.isArray(data) && typeof data == "object") {
      if ("transaction_hash" in data && data.transaction_hash != void 0) {
        this.transaction_hash = data.transaction_hash;
      }
...
var _ErrMsg = class _ErrMsg extends pb_15.Message {
  constructor(data) {
    ...
    pb_15.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __privateGet(this, _one_of_decls20));
    if (!Array.isArray(data) && typeof data == "object") {
      if ("code" in data && data.code != void 0) {
        this.code = data.code;
      }
...
var _PrepareQueryRequest = class _PrepareQueryRequest extends pb_15.Message {
  constructor(data) {
    ...
    pb_15.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2, 3, 4], __privateGet(this, _one_of_decls21));
    if (!Array.isArray(data) && typeof data == "object") {
      if ("chain_id" in data && data.chain_id != void 0) {
        this.chain_id = data.chain_id;
      }
      ...
      if ("use_app_circuit_info" in data && data.use_app_circuit_info != void 0) {
  ...
  get use_app_circuit_info() {
    return pb_15.Message.getFieldWithDefault(this, 6, false);
  }
  set use_app_circuit_info(value) {
    pb_15.Message.setField(this, 6, value);
  }
  get target_chain_id() {
    return pb_15.Message.getFieldWithDefault(this, 7, 0);
  }
...
var _PrepareQueryResponse = class _PrepareQueryResponse extends pb_15.Message {
  constructor(data) {
    ...
    pb_15.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __privateGet(this, _one_of_decls22));
    if (!Array.isArray(data) && typeof data == "object") {
      if ("err" in data && data.err != void 0) {
        this.err = data.err;
      }
...
var Brevis = class {
  ...
  submit(request, proof, srcChainId, dstChainId) {
    return __async(this, null, function* () {
      const res1 = yield this._prepareQuery(request, proof.circuit_info, srcChainId, dstChainId);
      if (res1.has_err) {
        throw new Error(`failed to submit ${res1.err.msg}`);
      }
      console.log("brevis request id", res1.query_hash);
      const res2 = yield this._submitProof(res1.query_hash, dstChainId, proof.proof);
      if (res2.has_err) {
  ...
  prepareQuery(request, circuitInfo, srcChainId, dstChainId) {
    return __async(this, null, function* () {
      return this._prepareQuery(request, circuitInfo, srcChainId, dstChainId);
    });
  }
  submitProof(id, dstChainId, proof) {
    return __async(this, null, function* () {
      yield this._submitProof(id, dstChainId, proof);
    });
  }
  ...
  wait(id, dstChainId) {
    return __async(this, null, function* () {
      ...
      for (let i = 0; i < count; i++) {
        const res = yield this.getQueryStatus(id, dstChainId);
        switch (res.status) {
          case 4 /* QS_COMPLETE */:
  ...
  _prepareQuery(request, circuitInfo, srcChainId, dstChainId) {
    return __async(this, null, function* () {
  ...
  _submitProof(id, dstChainId, proof) {
    return __async(this, null, function* () {
...
function validateReceipt(d) {
  if (d.block_num < 0)
    err("receipt.block_num", d.block_num);
  if (!validLen(d.tx_hash))
    err("transaction.tx_hash", d.tx_hash);
...
function validateReceiptField(d, i) {
  ...
  if (!ethers2.isAddress(d.contract))
    err(field + ".contract", d.contract);
  if (d.log_index < 0)
    err(field + ".log_index", d.log_index);
  if (!validLen(d.event_id))
    err(field + ".event_id", d.event_id);
  if (d.field_index < 0)
    err(field + ".field_index", d.field_index);
  if (!validLen(d.value))
    err(field + ".value", d.value);
}
function validateStorage(d) {
  if (d.block_num < 0)
    err("storage.block_num", d.block_num);
  if (!ethers2.isAddress(d.address))
    err("storage.address", d.address);
  if (!validLen(d.slot))
    err("storage.slot", d.slot);
  if (!validLen(d.value))
    err("storage.value", d.value);
}
function validateTransaction(d) {
  if (!validLen(d.hash))
    err("transaction.hash", d.hash);
  if (d.block_num < 0)
    err("transaction.block_num", d.block_num);
  if (d.nonce < 0)
    err("transaction.nonce", d.nonce);
  if (!validLen(d.gas_tip_cap_or_gas_price))
    err("transaction.gas_tip_cap_or_gas_price", d.gas_tip_cap_or_gas_price);
  if (!validLen(d.gas_fee_cap))
    err("transaction.gas_fee_cap", d.gas_fee_cap);
  if (d.gas_limit < 0)
    err("transaction.gas_limit", d.gas_limit);
  if (!ethers2.isAddress(d.from))
    err("transaction.from", d.from);
  if (!ethers2.isAddress(d.to))
    err("transaction.to", d.to);
  if (!validLen(d.value))
    err("transaction.value", d.value);
}
function validLen(d) {
